...
class HeteroGraphSAGE(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_node_types, type_embedding_dim, dropout_rate):
        ...
        self.relation_pred = Linear(2 * out_channels, len(edge_type_names))  # To be updated later based on the number of edge types
...
# Initialize counts of correct predictions and total predictions for different cases
correct_uses = 0
correct_indicates = 0
